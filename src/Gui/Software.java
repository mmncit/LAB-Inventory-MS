...
public class Software extends javax.swing.JPanel {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            ...
            ServiceHandler obj = new ServiceHandler();
        try {
            obj.Software_UPDATE(value1,value2,value3,value4);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            ServiceHandler obj = new ServiceHandler();
        try {
            obj.Software_INSERT(value1,value2,value3,value4);
        } catch (SQLException ex) {
           // Logger.getLogger(Software.class.getName()).log(Level.SEVERE, null, ex);
             System.out.println(ex.getMessage());
        } catch (ClassNotFoundException ex) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (p == 0) {
            ...
            ServiceHandler obj = new ServiceHandler();
            obj.Software_DELETE(Table_click);
    ...
    private void software_tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_software_tableMouseClicked
        try {
            ...
            String Table_click = (software_table.getModel().getValueAt(row, 0).toString());
            ServiceHandler obj = new ServiceHandler();
            rs = obj.Software_QUERY(Table_click);
           

            while (rs.next()) {

                String add1 = rs.getString("Software_ID");
                txt_softid.setText(add1);




                String add3 = rs.getString(2);
                txt_softname.setText(add3);
                
                String add6 = rs.getString(3);
