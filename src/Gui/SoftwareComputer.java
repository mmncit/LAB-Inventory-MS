...
public class SoftwareComputer extends javax.swing.JPanel {
    ...
    private void FillpcCombo(){
        ...
        pcid_ComboBox.removeAllItems();
        try{
            ServiceHandler obj = new ServiceHandler();
            rs = obj.Micro_Computer_ALL();
            while(rs.next()){
        
                String name = rs.getString("PC_ID");
     ...
     private void FillsoftCombo(){
         ...
         softid_ComboBox.removeAllItems();
        try{
            ServiceHandler obj = new ServiceHandler();
            rs = obj.Software_ALL();
            while(rs.next()){
        
                String name = rs.getString("Software_ID");
     ...
     private void Fillsoft2Combo(){
      ...
      private void Update_pctable(){
        try{
            ...
            String Softid=(String)ComboBox_soft.getSelectedItem();
            ServiceHandler obj = new ServiceHandler();
            rs = obj.PC_ALL_for_OneSoft(Softid);
       ...
       private void Update_softwaretable(){
        try{
            ...
            String PCID=(String)pcid_ComboBox.getSelectedItem();
            ServiceHandler obj = new ServiceHandler();
            rs = obj.Soft_ALL_for_OnePC(PCID);
    ...
    private void pcid_ComboBoxPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_pcid_ComboBoxPopupMenuWillBecomeInvisible
       Update_softwaretable();
        ...
        try{
            ServiceHandler obj = new ServiceHandler();
            rs = obj.Micro_Computer_QUERY(tmp);
    ...
    private void softid_ComboBoxPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_softid_ComboBoxPopupMenuWillBecomeInvisible
          String Softid=(String)softid_ComboBox.getSelectedItem();
      
        try{
           
            ServiceHandler obj = new ServiceHandler();
            rs = obj.Software_QUERY(Softid);
            
            if(rs.next()){
                
                String add1=rs.getString("Name_of_Software");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
            ...
            String PCID=(SoftPCSearch_table1.getModel().getValueAt(row,0).toString());
            String Softid=(String)ComboBox_soft.getSelectedItem();
            ServiceHandler obj = new ServiceHandler();
            obj.Soft_PC_DELETE(PCID,Softid);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            String Softid=(installedsoft_table.getModel().getValueAt(row,0).toString());
            String PCID=(String)pcid_ComboBox.getSelectedItem();
            ServiceHandler obj = new ServiceHandler();
            obj.Soft_PC_DELETE(PCID, Softid);
            JOptionPane.showMessageDialog(null, "Data is deleted");
    ...
    private void cmd_instllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_instllActionPerformed
         try{
            ...
            String Softid=(String)softid_ComboBox.getSelectedItem();
            ServiceHandler obj = new ServiceHandler();
            obj.Soft_PC_INSERT(PCID, Softid,((JTextField)txt_choosedate.getDateEditor().getUiComponent()).getText());
