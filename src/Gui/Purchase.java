...
public class Purchase extends javax.swing.JPanel {
   ...
   TableRowSorter<TableModel> sorter = null;
    ...
    private void FillCombo() {
        ...
        chooseitem_ComboBox.removeAllItems();
        choosebrand_ComboBox.removeAllItems();
        try {

            ServiceHandler obj = new ServiceHandler();
            rs = obj.Purchase_DISTINCT_Item_Brand();
            while (rs.next()) {
    ...
    private void purchase_tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_purchase_tableMouseClicked
        try {
            ...
            ServiceHandler obj = new ServiceHandler();
            rs = obj.Purchase_QUERY(Table_click);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ServiceHandler obj = new ServiceHandler();
        try {
            obj.Purchase_INSERT(value1, value2, value3, value4, value5, value6, value7, value8, value9);
            JOptionPane.showMessageDialog(null, "New data is Inserted");
    ...
    private void cmd_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_updateActionPerformed
        ...
        ServiceHandler obj = new ServiceHandler();
        try {
            obj.Purchase_UPDATE(value1, value2, value3, value4, value5, value6, value7, value8, value9);
    ...
    private void cmd_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_deleteActionPerformed
        ...
        if (p == 0) {
            ...
            try {
                ServiceHandler obj = new ServiceHandler();
                obj.Purchase_DELETE(txt_purchaseid.getText());
